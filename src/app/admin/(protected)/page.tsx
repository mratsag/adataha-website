...
import { Package, FolderOpen, TrendingUp, Heart } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl text-blue-900">Hoş Geldiniz!</CardTitle>
          <CardDescription className="text-blue-700">
            Bugün nasılsınız? Adataha admin panelinde yeni bir güne başlıyoruz. 
