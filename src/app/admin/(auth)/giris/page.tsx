...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Şifre kontrolü - hem hash'li hem plain text destekler
      ...
      if (!passwordValid) {
        // Hash'li şifre geçersizse veya yoksa plain text kontrol et
        const envPassword = process.env.NEXT_PUBLIC_ADMIN_PASSWORD
        passwordValid = password === "admin123" || password === envPassword
      }
